import './StudyRegistrationPage.css';
  ...
  return (
    <div className="content__box">
      ...
      <form className="study__create">
        ...
        <div className="choice__background">
          <label>배경을 선택해주세요</label>
          <div className="background__items">
            {backgrounds.map((bg) => (
              <button key={bg.id} type="button" className="background__item" style={{ background: bg.color }} />
            ))}
          </div>
        </div>
        <div className="password">
          <label htmlFor="passInput">비밀번호</label>
          <input id="passInput" type="password" placeholder="비밀번호를 입력해 주세요" />
        </div>
        <div className="password__check">
          <label htmlFor="passCheck">비밀번호 확인</label>
          <input id="passCheck" type="password" placeholder="비밀번호를 입력해 주세요" />
        </div>
        <div className="submit__btn">
          <button className="study__create__btn" type="submit">
            만들기
          </button>
        </div>
      </form>
